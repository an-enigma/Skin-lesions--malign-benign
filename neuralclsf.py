...
for i in range(0,len(classificationst)):
    t=np.asarray(classificationst[i])             #mutable 
    features.append(t)
print(len(features))
input_images=np.asarray(features)

input_images=input_images/255.0000
labels=[]
...
classific10=load_images_from_folder("test1")   #benign
classific20=load_images_from_folder("test2")   #malign

classificationstza=classific10+classific20
features2=[]
for i in range(0,len(classificationstza)):
    t=np.asarray(classificationstza[i])
    features2.append(t)
test_images1748=np.asarray(features2)
test_images1748=test_images1748/255.000
